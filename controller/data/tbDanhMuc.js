...
import { getIsActiveItem, getDanhSachPhanCapDanhMuc, checkIsExisted } from '../../common/utils/filter';
...
async function getTable(req, res) {
  let rhApiUrl = _configs.rh.dataUrl + '/tbDanhMuc' + await getDanhSachPhanCapDanhMuc(req);
...
async function post(req, res) {
  ...
  let checkIsEx = await checkIsExisted('tbDanhMuc', 'Ma', req.body.Ma)
  if (checkIsEx) {
  ...
  req.body.PheDuyet = 1
  let rhApiUrl = _configs.rh.dataUrl + '/tbDanhMuc' + req.url;
