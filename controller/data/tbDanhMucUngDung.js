...
function getTable(req, res) {
  let rhApiUrl = _configs.rh.dataUrl + '/tbDanhMucUngDung' + getIsActiveItem(req);
...
async function post(req, res) {
  ...
  let checkIsEx = await checkIsExisted('tbDanhMucUngDung', 'Ma', req.body.Ma)
  if (checkIsEx) {
  ...
  let rhApiUrl = _configs.rh.dataUrl + '/tbDanhMucUngDung' + req.url;
