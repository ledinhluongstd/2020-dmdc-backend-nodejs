...
function getTable(req, res) {
  let rhApiUrl = _configs.rh.dataUrl + '/tbThuocTinhDanhMuc' + getIsActiveItem(req);
...
async function post(req, res) {
  ...
  let checkIsEx = await checkIsExisted('tbThuocTinhDanhMuc', 'Ma', req.body.Ma)
  if (checkIsEx) {
  ...
  let rhApiUrl = _configs.rh.dataUrl + '/tbThuocTinhDanhMuc' + req.url;
