...
import { getIsActiveItem, getDanhSachPhanCapUser } from '../../common/utils/filter';
...
async function getTable(req, res) {
  let rhApiUrl = _configs.rh.dataUrl + '/tbUsers' + await getDanhSachPhanCapUser(req);
...
function post(req, res) {
  ...
  let rhApiUrl = _configs.rh.dataUrl + '/tbUsers' + req.url;
